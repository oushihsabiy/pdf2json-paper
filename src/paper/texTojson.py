...
LATEX_TO_JSON_PROMPT_TEMPLATE = (
    ...
    "2) Prefer extracting theorem/lemma/definition/proposition/algorithm statements and their proofs when present.\n"
...
EXTRACT_DEFINITIONS_PROMPT_TEMPLATE = (
    ...
    "Return VALID JSON ONLY (no markdown, no comments, no extra text).\n\n"
    "Output: a JSON array. Each element is an object with keys:\n"
    "  - content: the definition statement in LaTeX\n"
    "  - proof: \"\" (empty string, as definitions typically don't have proofs)\n\n"
    "Rules:\n"
    "1) Only extract definitions that are not already explicitly marked as such.\n"
    "2) Look for phrases like 'we define', 'is defined as', 'let us denote', 'we say that', etc.\n"
    "3) Preserve the original wording and math formulas.\n"
    "4) If no implicit definitions are found, output [].\n\n"
    "LaTeX text:\n<<<LATEX>>>\n__LATEX__\n<<<END>>>\n"
)
